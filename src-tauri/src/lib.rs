...
mod app_init {
    ...
    pub fn generate_handlers() -> impl Fn(tauri::ipc::Invoke<tauri::Wry>) -> bool + Send + Sync + 'static {
        tauri::generate_handler![
            ...
            // Smart Node Center commands
            cmd::snc_get_pool,
            cmd::snc_add_nodes,
            cmd::snc_remove_node,
            cmd::snc_get_pool_stats,
            cmd::snc_import_nodes,
            cmd::snc_export_nodes,
            cmd::snc_get_groups,
            cmd::snc_create_group,
            cmd::snc_update_group,
            cmd::snc_delete_group,
            cmd::snc_detect_group,
            cmd::snc_test_node_speed,
            cmd::snc_test_all_nodes,
            cmd::snc_switch_group_node,
            cmd::snc_check_node_health,
            cmd::snc_check_all_health,
            cmd::snc_get_today_history,
            cmd::snc_cleanup_history,
            cmd::snc_get_dashboard_data,
            cmd::snc_is_enabled,
            cmd::snc_toggle_enabled,
            cmd::snc_get_config,
            cmd::snc_patch_config,
        ]
    }
}
